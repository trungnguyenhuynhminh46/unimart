    ...
    <div class="secion" id="breadcrumb-wp">
        <div class="secion-detail">
            <ul class="list-item clearfix">
                ...
                <li>
                    <a href="#" class="active">{{ $post_cat->name }}</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="main-content fl-right">
        <div class="section" id="list-blog-wp">
            <div class="section-head clearfix">
                @if ($posts->total() > 0)
                    <h1 class="section-title blog-title">Các bài viết với chủ đề {{ $post_cat->name }}</h1>
                @else
                    <h1 class="section-title blog-title">Không có bài viết nào với chủ đề {{ $post_cat->name }}</h1>
                @endif
            </div>
